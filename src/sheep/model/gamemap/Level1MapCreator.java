...
public class Level1MapCreator extends MapCreator {
	...
	public GameMap createMap(Model model) {
		...
		map.add(loc, myDec);
		map.add(loc,new River(model,loc,Direction.NE,10,rc, myDec));
		...
		myDec = new Decal("arrow",model,loc);
		map.add(loc, myDec);
		map.add(loc,new River(model,loc,Direction.N,10,rc, myDec));
		...
		myDec = new Decal("arrow",model,loc);
		map.add(loc, myDec);
		map.add(loc,new River(model,loc,Direction.SE,10,rc, myDec));
		...
		myDec = new Decal("arrow",model,loc);
		map.add(loc, myDec);
		map.add(loc,new River(model,loc,Direction.S,10,rc, myDec));
		...
		myDec = new Decal("arrow",model,loc);
		map.add(loc, myDec);
		map.add(loc,new River(model,loc,Direction.SW,10,rc, myDec));
		...
		myDec = new Decal("arrow",model,loc);
		map.add(loc, myDec);
		map.add(loc,new River(model,loc,Direction.NW,10,rc, myDec));
